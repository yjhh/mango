...
<html>
	<head>
		...
		<!-- <script src="js/pdl_store_order_manager/store_order_waitfordo.js"></script> -->
	...
	<!-- 	<script src="js/jquery.js"></script> -->
		...
		$(function(){
			//状态1为未支付，2为已支付
			//alert("kajhfd");
			ajax_order("2",${sessionScope.store_id},current);
				...
				success:function(porder){
					...
					if(porder.list.length>0){
						...
						$(".edit").click(function(){
							...
							$.get("user_editOrder_ajax",{"type":4,"order_id":$(this).next().text()},function(rs){
								alert(rs=="true"?"操作成功":"操作失败");
								$("#order_id").empty();
