...
<html>
	<head>
		...
		<!-- <script src="js/pdl_store_good_manager/store_good_del.js"></script> -->
			...
			<div id="main">
				...
				<div id="left_block">
					<div id="items">
						...
						<div id="store_orders">
							...
							<label><a href="store_order_completed">已完成订单</a></label>
						</div>
						<div id="store_infos">
							<div>
				...
				<div id="right_block">
                    ...
                    -->
							...
							<table id="order_items" >
								<thead>
									<tr>
										...
										<td style="width:200px;text-align:center;"><a href="store_add_good.jsp">宝贝上架</a></td>
						...
						<div class="firstMsg"style="width: 800px;height: 30px;margin-top: 30px;text-align: center;font-size:16pt ;color: gray;" > 
							这里空空如也，请选择要删除的商品~~
						</div>
		                <!--
	                    	商品
			...
			$.ajax({
				...
				success:function(pgoods){
					...
					if(pgoods.list.length>0){
							...
							/*alert(pgoods.list.length)*/
								...
								"<td  style='width:420px;'>"+
									...
									"<div style='margin-left:5px;padding-bottom:0px;clear:left;color:gray;float:left;font-size:12pt;display:inline-block;width:100px;height:20px;'>"+
										"已售：2333"+
									"</div>"+
									"<div style='margin-left:10px;padding-bottom:5px;float:left;color:gray;margin-left:10px;font-size:12pt;display:inline-block;width:100px;height:20px;'>"+(pgoods.list[i].stock>0?"库存："+
									pgoods.list[i].stock:"已下架")+
									"</div>"+
								"</td>"+
								"<td width='80px'>"+
						...
						$("#pagging").empty();
						$("#pagging").append("<span>这里空空如也，请先去添商品吧</span>");
					}
				}
			});
		}
