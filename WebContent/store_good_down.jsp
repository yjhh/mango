...
<html>
	<head>
		...
		<!-- <script src="js/pdl_store_good_manager/store_good_down.js"></script> -->
				...
				<div id="left_block">
					<div id="items">
						...
						<div id="store_goods">
							...
							<label ><a href="store_good-down.jsp">宝贝下架</a></label>
			...
			$.ajax({
				...
				success:function(pgoods){
					...
					if(pgoods.list.length>0){
						...
						$("#pagging").empty();
						$("#pagging").append("<span><span>这里空空如也，请先去添商品吧</span></span>");
					}
				}
			});
		}
