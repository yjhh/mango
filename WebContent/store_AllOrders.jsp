...
<html>
	<head>
		...
		<!-- <script src="js/pdl_store_order_manager/store_order.js"></script> -->
		...
		body{
			...
			div#pagging {margin-left:250px;padding: 15px 20px;text-align: left;color: #ccc;}
						...
						<div id="store_goods">
							...
							<!-- <div >
								<form style="margin-left:10px ;margin-top:20px;">
									<input type="text" name="goods_id" style="width:100px;" value="请输入商品编号或名字">
									<button>查询</button>
								</form>
							</div> -->
